...
const faqs = [
  {
    ...
    answer:
      "The prize pool for SUMOBOTS 2026 is over $3200! The exact prize breakdown for each category is currently being finalised.",
  },
  {
  ...
  {
    question: "How difficult is the competition?",
    answer:
