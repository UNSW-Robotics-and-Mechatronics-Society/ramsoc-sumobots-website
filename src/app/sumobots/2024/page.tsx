      ...
      <div className="min-h-screen w-full bg-black pt-12">
        <section className="container">
          ...
          <div className="col-span-full lg:col-span-7">
            ...
            <Link
              ...
              href={"/sumobots/2024/resources/2024 Sumobots Formal Rules.pdf"}
              target="_blank"
            >
              Rulebook
            </Link>
        ...
        <section className="container">
          ...
          <div className="col-span-full">
            ...
            <Link className="button mt-8" href={"/sumobots/2024/resources"}>
              Learn More
            </Link>
          </div>
        </section>
